import { HeartIcon, BookOpenIcon, SettingsIcon, ServerIcon, StarIcon } from "lucide-react";
    ...
    <section className="space-y-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        {hobbies.map((hobby, i) => {
          ...
          return (
            <Card key={i} className="border bg-card hover:shadow-sm hover:border-primary/20 transition-all group">
