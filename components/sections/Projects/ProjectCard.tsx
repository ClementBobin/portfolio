    ...
    >
      ...
      >
        <PerspectiveBook size="lg" textured={!!project.media}>
          {/* Media */}
          {project.media ? (
            <div className="relative h-24 w-full overflow-hidden rounded-md mb-3 bg-secondary shrink-0">
              <Image
                src={project.media}
                alt={title}
                sizes="220px"
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-accent/15 text-accent mb-3 shrink-0">
