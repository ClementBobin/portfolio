...
function Reminder() {
  return (
        <div>
          ...
          {/* Main content with motivational messages */}
          <p>
            {/* Strong emphasis on the importance of time and life */}
            ...
            to make it right.{' '}
            {/* Encouragement to help and inspire others */}
            <strong>
            ...
            {/* Encouragement to step out of the comfort zone */}
            ...
            and keep going. {/* Emphasis on personal responsibility and happiness */}
            Don't expect <strong>others to make you happy</strong>. You are the only one
            <strong>responsible for your happiness</strong>. <strong>Don't wait</strong>
            until Friday to enjoy life. Joy should be present in everything you do.{' '}
            {/* Respect for parents */}
            ...
            {/* Emphasis on the shortness of life and taking action */}
