      ...
      >
        ...
        >
          <label className='flex flex-col'>
            <span className='text-textColor font-medium mb-4'>Your Name</span>
            <input
              type='text'
              name='name'
              value={form.name}
          ...
          <label className='flex flex-col'>
            <span className='text-textColor font-medium mb-4'>Your email</span>
            <input
              type='email'
              name='email'
              value={form.email}
          ...
          <label className='flex flex-col'>
            <span className='text-textColor font-medium mb-4'>Your Message</span>
            <textarea
              rows={7}
              name='message'
              value={form.message}
