    ...
    <VerticalTimelineElement
      ...
      icon={
        <div className="flex justify-center items-center w-full h-full">
          <img src={experience.icon} srcSet={`${experience.icon} 1x, ${experience.iconFallback} 2x`} alt={experience.company_name} className="w-[60%] h-[60%] object-contain" loading="lazy"/>
        </div>
      }
    >
      <div>
