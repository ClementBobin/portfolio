...
function RenderResults() {
  ...
  return (
    ...
    {results && results.length != 0 && <div className='border-t-2 border-white-100 pb-3 pt-2'>
    <KBarResults
      items={results}
      onRender={({ item, active }) =>
        typeof item === 'string' ? (
          <div className='text-sm uppercase px-8 pt-3 pb-2 text-black-200 font-black tracking-widest'>{item}</div>
        ) : (
  ...
  const actions = [
    {
      ...
      section: 'General',
      perform: copyLink,
      icon: <Lottie lottieRef={copyLinkRef} className='w-6 h-6 invert dark:invert-0' animationData={copyLinkIcon} loop={false} autoplay={false} />,
    },
    {
      id: "Résumer",
      name: "Résumer",
      ...
      icon: <Lottie lottieRef={avatarRef} className='w-6 h-6 invert dark:invert-0' animationData={avatarIcons} loop={false} autoplay={false} />,
    },
    {
      id: "Porfolio",
      name: "portfolio",
      ...
      icon: <Lottie lottieRef={workRef} className='w-6 h-6 invert dark:invert-0' animationData={workIcons} loop={false} autoplay={false} />,
    },
    {
        id: "Test",
        name: "Testing",
        ...
        icon: <Lottie lottieRef={bugRef} className='w-6 h-6 invert dark:invert-0' animationData={bugIcons} loop={false} autoplay={false} />,
    },
    {
      id: '#contact',
      name: 'Send Email',
      ...
      icon: <Lottie lottieRef={emailRef} className='w-6 h-6 invert dark:invert-0' animationData={emailIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'source',
      name: 'View Source',
      ...
      icon: <Lottie lottieRef={sourceRef} className='w-6 h-6 invert dark:invert-0' animationData={sourceIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'home',
      name: 'Home',
      ...
      section: 'Go To',
      perform: () => (window.location.pathname = ''),
      icon: <Lottie lottieRef={homeRef} className='w-6 h-6 invert dark:invert-0' animationData={homeIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'about',
      name: 'About',
      ...
      icon: <Lottie lottieRef={aboutRef} className='w-6 h-6 invert dark:invert-0' animationData={aboutIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'articles',
      name: 'Articles',
      ...
      icon: <Lottie lottieRef={articlesRef} className='w-6 h-6 invert dark:invert-0' animationData={articlesIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'projects',
      name: 'Projects',
      ...
      icon: <Lottie lottieRef={projectsRef} className='w-6 h-6 invert dark:invert-0' animationData={projectsIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'talks',
      name: 'Talks',
      ...
      icon: <Lottie lottieRef={talksRef} className='w-6 h-6 invert dark:invert-0' animationData={talksIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'podcasts',
      name: 'Podcasts',
      ...
      icon: <Lottie lottieRef={podcastsRef} className='w-6 h-6 invert dark:invert-0' animationData={podcastsIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'investing',
      name: 'Investing',
      ...
      icon: <Lottie lottieRef={investingRef} className='w-6 h-6 invert dark:invert-0' animationData={investingIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'uses',
      name: 'Uses',
      ...
      icon: <Lottie lottieRef={usesRef} className='w-6 h-6 invert dark:invert-0' animationData={usesIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'reminder',
      name: 'Reminder',
      ...
      icon: <Lottie lottieRef={reminderRef} className='w-6 h-6 invert dark:invert-0' animationData={reminderIcon} loop={false} autoplay={false} />,
    },
    {
      id: 'Dark',
      name: 'DarkTheme',
      ...
      icon: <Lottie lottieRef={darkRef} className='w-6 h-6 invert-0 dark:invert' animationData={darkIcons} loop={false} autoplay={false} />,
    },
    {
      id: 'Light',
      name: 'LightTheme',
      ...
      icon: <Lottie lottieRef={lightRef} className='w-6 h-6 invert-0 dark:invert' animationData={lightIcons} loop={false} autoplay={false} />,
    },
  ];
