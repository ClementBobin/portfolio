...
const Tech = () => {
  ...
  return (
    <div className={`mt-12 bg-transparent rounded-[20px]`}>
      <div className={`relative bg-transparent backdrop-filter backdrop-blur-lg border border-white border-opacity-20 rounded-lg z-[8] hover:backdrop-blur-none hover:border-none ${styles.padding}`}>
